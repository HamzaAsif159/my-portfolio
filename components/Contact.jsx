  ...
  return (
    <section>
      <div className="h-48 max-w-6xl mx-auto antialiased bg-gray-800">
        <h1 className="py-20 pb-16 text-5xl font-bold text-center text-white  md:text-9xl md:text-left">
          Contact
        </h1>
      </div>
          ...
          <div className="md:ml-4">
            ...
            <div className="inline-flex flex-col my-20 icons-container">
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4">
                ...
                <p className="text-sm font-light text-gray-50">{Data.phone}</p>
              </div>
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="text-sm font-light text-gray-50">{Data.email}</p>
              </div>
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
